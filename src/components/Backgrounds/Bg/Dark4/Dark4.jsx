...
import DarkPreview4 from "./DarkPreview4";
...
const Dark4 = () => {
  ...
  const copyCode = () => {
    const codeToCopy = `<div className="absolute top-0 z-[-2] h-screen w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>`;
  ...
  return (
    <div className="relative w-64 overflow-hidden rounded-lg shadow-lg h-80 group">
      ...
      {isPreviewOpen && <DarkPreview4 onClose={closePreview} />}
    </div>
  );
};
