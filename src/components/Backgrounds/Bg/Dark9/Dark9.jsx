...
import DarkPreview9 from "./DarkPreview9";
...
const Dark9 = () => {
  ...
  const copyCode = () => {
    const codeToCopy = `<div className="absolute top-0 z-[-2] h-screen w-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px]"></div>`;
  ...
  return (
    <div className="relative w-64 overflow-hidden rounded-lg shadow-lg h-80 group">
      ...
      {isPreviewOpen && <DarkPreview9 onClose={closePreview} />}
    </div>
  );
};
