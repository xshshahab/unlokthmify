...
import DarkPreview2 from "./DarkPreview2";
...
const Dark2 = () => {
  ...
  const copyCode = () => {
    const codeToCopy = `<div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]"></div>`;
  ...
  return (
    <div className="relative w-64 overflow-hidden rounded-lg shadow-lg h-80 group">
      ...
      {isPreviewOpen && <DarkPreview2 onClose={closePreview} />}
    </div>
  );
};
