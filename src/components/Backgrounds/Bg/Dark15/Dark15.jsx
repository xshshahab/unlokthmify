...
import DarkPreview15 from "./DarkPreview15";
...
const Dark15 = () => {
  ...
  const copyCode = () => {
    const codeToCopy = `<div className="relative w-full h-full bg-black">
...
`;
  ...
  return (
    <div className="relative w-64 overflow-hidden rounded-lg shadow-lg h-80 group">
      ...
      {isPreviewOpen && <DarkPreview15 onClose={closePreview} />}
    </div>
  );
};

export default Dark15;
