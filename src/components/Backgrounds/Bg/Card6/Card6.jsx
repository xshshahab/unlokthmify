...
const Card6 = () => {
  ...
  const copyCode = () => {
    const codeToCopy = `<div className="absolute top-0 z-[-2] h-full w-full bg-white bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]"></div>`;
  ...
  return (
    <div className="relative w-64 overflow-hidden rounded-lg shadow-lg h-80 group">
      ...
      {isPreviewOpen && <Preview6 onClose={closePreview} />}
    </div>
  );
};
