...
const Btn24 = () => {
  const handleCopy = () => {
    const code = `<button className="group relative z-0 h-12 overflow-hidden overflow-x-hidden rounded-md bg-neutral-800 hover:text-black hover:font-bold px-8 py-2 text-neutral-50">
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button className="group relative z-0 h-12 overflow-hidden overflow-x-hidden rounded-md bg-slate-200 hover:text-black hover:font-bold px-8 py-2 text-neutral-900">
          <span className="relative z-10">Hover Me</span>
          <span className="absolute inset-0 overflow-hidden rounded-md">
            <span className="absolute left-0 aspect-square w-full origin-center translate-x-full rounded-full bg-green-500 transition-all duration-500 group-hover:-translate-x-0 group-hover:scale-150"></span>
          </span>
