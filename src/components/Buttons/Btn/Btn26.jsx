...
const Btn26 = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-green-500 px-6 font-medium text-neutral-950 hover:text-black hover:font-bold">
          <span className="absolute h-56 w-32 rounded-full bg-slate-200 transition-all duration-300 group-hover:h-0 group-hover:w-0"></span>
          <span className="relative">Hover me</span>
        </button>
        <span
          onClick={handleCopy}
