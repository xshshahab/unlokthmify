...
const Btn36 = () => {
  const handleCopy = () => {
    const code = `<button className="relative inline-flex items-center justify-center h-12 px-6 overflow-hidden font-medium duration-500 border rounded-md group bg-slate-100 text-neutral-950 border-slate-200">
          <div className="relative inline-flex items-center transition -translate-x-0 group-hover:translate-x-6">
            <div className="absolute transition -translate-x-4 opacity-0 group-hover:-translate-x-6 group-hover:opacity-100">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
            ...
            <div className="absolute right-0 transition translate-x-0 opacity-100 group-hover:translate-x-4 group-hover:opacity-0">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button className="relative inline-flex items-center justify-center h-12 px-6 overflow-hidden font-medium duration-500 border rounded-md group bg-slate-100 text-neutral-950 border-slate-200">
          <div className="relative inline-flex items-center transition -translate-x-0 group-hover:translate-x-6">
            <div className="absolute transition -translate-x-4 opacity-0 group-hover:-translate-x-6 group-hover:opacity-100">
              <svg
                width="15"
