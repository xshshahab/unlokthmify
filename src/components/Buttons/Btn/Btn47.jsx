...
const Btn47 = () => {
  const handleCopy = () => {
    const code = `<button className="relative inline-flex items-center justify-center h-12 px-6 font-medium rounded-md group bg-neutral-950 text-neutral-200">
          <span>Hover me</span>
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button className="relative inline-flex items-center justify-center h-12 px-6 font-medium rounded-md group bg-neutral-950 text-neutral-200">
          <span>Hover me</span>
          <div className="relative w-5 h-5 ml-1 overflow-hidden">
            <div className="absolute transition-all duration-200 group-hover:-translate-y-5 group-hover:translate-x-4">
              <svg
