...
const Btn38 = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button className="relative px-6 py-3 font-semibold text-white transition-all duration-300 ease-in-out border border-gray-600 rounded-lg shadow-md bg-gray-950 group hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <span className="absolute inset-0 w-full h-full transition-transform transform scale-0 rounded-lg bg-gradient-to-r from-purple-800 to-sky-500 group-hover:scale-100 opacity-30"></span>
          <span className="relative z-10">Hover me</span>
        </button>
