...
const Btn30 = () => {
  const handleCopy = () => {
    const code = `<button
          disabled=""
          className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-slate-200 px-6 font-medium text-neutral-950 disabled:pointer-events-none disabled:opacity-50"
        >
          <svg
            width="15"
            height="15"
            ...
            className="mr-1 h-5 w-5 animate-spin text-black"
          >
            <path
