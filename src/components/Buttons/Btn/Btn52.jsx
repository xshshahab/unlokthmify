...
const Btn52 = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between show">
      ...
      >
        <button class="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 font-medium"><div class="inline-flex h-12 translate-y-0 items-center justify-center bg-black px-6 text-neutral-100 transition group-hover:-translate-y-[150%]">Hover me</div><div class="absolute inline-flex h-12 w-full translate-y-[100%] items-center justify-center bg-green-700 px-6 text-neutral-50 transition duration-300 group-hover:translate-y-0">Hover me</div></button>
